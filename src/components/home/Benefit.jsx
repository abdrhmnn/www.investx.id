        ...
        <div className="benefit-list">
          ...
          <div className="parag">
            ...
            <ul>
              <li>
                {" "}
                <i className="fas fa-star"></i> Raise up to $1M of
                founder-friendly capital
              </li>
              <li>
                {" "}
                <i className="fas fa-star"></i> Drive key metrics and market
                your business
              </li>
              <li>
                {" "}
                <i className="fas fa-star"></i> Build a loyal army of
                evangelists and fans
              </li>
              <li>
                {" "}
                <i className="fas fa-star"></i> verage raise: $500,000+ from
                1,500+ investors*
              </li>
              <li>
                {" "}
                <i className="fas fa-star"></i> 90%+ success rate since 2016
              </li>
            </ul>
          </div>
        </div>
        <div className="benefit-icons container">
          <div className="row align-items-center text-center">
            <div className="col-md box-ben ">
              ...
              <div className="desc">
                Less than 3% of startups that apply pass through our due
            ...
            <div className="col-md box-ben ">
              ...
              <div className="desc">
                InvestX is investor-friendly by design with no hidden fees and
            ...
            <div className="col-md box-ben ">
              ...
              <div className="desc">
                Industry-lowest minimums starting as low as $10 also help you
            ...
            <div className="col-md box-ben ">
              ...
              <div className="desc">
                We launched to level the playing field for entrepreneurs and
                investors.
              </div>
            </div>
          </div>
