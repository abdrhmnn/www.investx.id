...
class Otp extends Component {
  ...
  compModalSuccessOtp = () => {
    return (
      ...
      <div className="box-modal-verifyemail">
        ...
        <p className="desc">
          Segera Verifikasi email anda dan isi data untuk melakukan kegiatan di
          InvestX
        </p>
        <p className="lab">Email Anda :</p>
        <p className="email">lallala@email.com</p>
        <p className="info">
          Belum menerima email aktivasi? <span>kirim ulang</span> dalam 47 detik
        </p>
        <div className="box-butt">
          ...
          {/* sementarta  */}
          <Link to="/select-form">
            <Button className="bmail">
              {" "}
              <img src={emailicon} alt="email" /> Buka Email
            </Button>
          </Link>
        </div>
      </div>
  ...
  render() {
    return (
      <div>
        <ModalTemplate
          onOpen={this.state.onOpenModal}
          component={this.compModalSuccessOtp}
        />
        <Navbar removePopUp />
