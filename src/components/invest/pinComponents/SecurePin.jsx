  ...
  return (
    <div className="pin_components">
      ...
      <div className="box_inp_pin">
        ...
        <p className="desc">
          Masukan kode 6 angka sebagai security PIN akun anda
        </p>
        <Formik
          initialValues={{
            newPin: "",
          ...
          {({ values, handleChange, handleSubmit }) => (
            <form className="wrapperform" onSubmit={handleSubmit}>
              ...
              <input
                type="password"
                value={values.dataInput}
                onChange={handleChange("re_newPin")}
                placeholder="Konfirmasi Security Pin"
                required
              />
              <Button type="submit" className="verif-button">
                BUAT PIN
              </Button>
            </form>
          )}
