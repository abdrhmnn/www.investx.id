        ...
        const codeModal = [
            {
                ...
                button: () => (
                    <InputFiles
                        onChange={(files) =>
                            this.handleFileUpload(files, "ktp")
                        }
                    >
            ...
            },
            {
                ...
                button: () => (
                    <InputFiles
                        onChange={(files) =>
                            this.handleFileUpload(files, "selfie")
                        }
                    >
                        <Button>Ok, Upload Sekarang</Button>
                    </InputFiles>
            ...
            },
            {
                ...
                button: () => (
                    <InputFiles
                        onChange={(files) =>
                            this.handleFileUpload(files, "npwp")
                        }
                    >
                        <Button>Ok, Upload Sekarang</Button>
                    </InputFiles>
            ...
            <Fade in={this.state.modalFile.open}>
                ...
                >
                    <div className="box-mod">
                        ...
                        <p className="info">
                            *File data <span>Pdf / Jpeg / PNG</span> dan tidak
                            lebih dari <span>5MB</span>{" "}
                        </p>
                    </div>
                </div>
            </Fade>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-12">
                                        <p className="info-dok">
                                            * Jika Anda belum memiliki NPWP dan
                                            ingin berinvestasi, bisa dikosongkan
                                            terlebih dahulu. Namun,
                                            <span>
                                                {" "}
                                                NPWP merupakan syarat wajib
                                                untuk bisa melakukan penarikan
                                                deviden pada Saldo InvestX.{" "}
                                            </span>
                                            Anda bisa membuat NPWP secara online
                                            di{" "}
