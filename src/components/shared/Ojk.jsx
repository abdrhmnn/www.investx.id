        ...
        <div className="container">
          ...
          <div className="row">
            <div className="col-md-6  border-right">
              <p>
                InvestX adalah Penyelenggara layanan urun dana melalui penawaran
                saham berbasis teknologi informasi (equity crowdfunding) dimana
                penerbit menawarkan saham bisnis kepada investor melalui
                jaringan sistem elektronik yang telah mendapatkan izin dari
            ...
            <div className="col-md-6">
              ...
              {/* <p>
                ...
                <br />
                Harap menggunakan pertimbangan ekstra dalam membuat keputusan
                untuk membeli saham. Ada kemungkinan Anda tidak bisa menjual
                kembali saham bisnis dengan cepat.
                <br />
                Lakukan diversifikasi investasi, hanya gunakan dana yang siap
                Anda lepaskan (affors to loose) dan atau disimpan dalam jangka
                panjang.
                <br />
                InvestX tidak memaksa pengguna untuk membeli saham bisnis
                sebagai investasi. Semua keputusan pembelian merupakan keputusan
                independen oleh pengguna.
                <br />
                InvestX bertindak sebagai penyelenggara urun dana yang
                ...
                investasi.
                <br />
                Keputusan pembelian saham, sepenuhnya merupakan hak dan tanggung
                jawab Pemodal (investor).
                <br />
                Dengan membeli saham di Santara berarti Anda sudah menyetujui
