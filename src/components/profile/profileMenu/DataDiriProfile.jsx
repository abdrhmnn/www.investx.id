...
import {Checkbox, ButtonGroup, Button, FormHelperText, Tabs, Tab,Collapse} from '@material-ui/core'
...
class DataDiriProfile extends Component {
    ...
    render() {
        ...
        return (
            <div className='data-diri-prof all-forms-style ' style={{padding : '90px 100px 70px', backgroundColor :'white', justifyContent: 'unset', alignItems: 'unset'}}>
                <Tabs
                    ...
                    >
                        <Tab style={{fontSize : 16, minWidth : '25%', textTransform : 'capitalize', }} label="Data diri" />
                        <Tab style={{fontSize : 16, minWidth : '25%', textTransform : 'capitalize', }} label="Rekening Bank" />
                ...
                <Collapse in={tabActive === 0}>
                    <div className="box-form-data" style={{border: 'none', padding : 'unset', margin : 'unset', width: 'unset'}}>
                        ...
                        }}>
                        {
                            ...
                            <form onSubmit={handleSubmit} id='investorForm' > 
                                <div className="row">
                                    ...
                                    <div className="col-md-12 ">
                                        <ButtonGroup className={errors.gender?'button-gender line-error':'button-gender'} disabled={!this.state.edit}>
                        ...
                        <div className="foot-data-diri mt-5" style={{justifyContent: 'space-between', width: 'unset'}}>
                            <p className="pagreement">*Saya menjamin bahwa informasi yang saya cantumkan diatas adalah benar dan siap bertanggung jawab atas segala konsekuensi yang terjadi di kemudian hari, serta memiliki kemampuan analisis resiko terhadap saham penerbit dan memenuhi kriteria pemodal sesuai peraturan yang berlaku.</p>
                            <Button disabled={!this.state.edit} className='pbuttonsub' type='submit' form='investorForm' style={{width : 200, height:60}}>SIMPAN</Button>
                        </div>
                </div>
                </Collapse>
