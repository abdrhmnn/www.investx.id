...
class RekeningTab extends Component {
    state ={
        ...
        isBankExist : true,
        objListBank : [
            { id : 0, bank: 'BCA', an: 'Dewi Kartika', norek : '12525522525252', logoBank : 'logohere! :)'},
            { id : 1, bank: 'BRI', an: 'Dewi Kartika', norek : '12525522525252', logoBank : 'logohere! :)'},
            { id : 2, bank: 'MANDIRI', an: 'Dewi Kartika', norek : '12525522525252', logoBank : 'logohere! :)'},
        ]
    }
    ...
    comListBank = () =>
        <div className='list-rektab '>
            ...
            <Button onClick={this.openMod}><img src={plustopup} alt="add-bank"/>Tambah Bank</Button>
        </div>
