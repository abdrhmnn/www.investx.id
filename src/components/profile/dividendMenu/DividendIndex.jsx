        ...
        <div className="riwayat-dividend">
          ...
          <div className="ketentuan-bagi-hasil">
            ...
            <ol style={{ paddingLeft: "12px" }}>
              <li>Pencairan dana hanya bisa dilakukan sebanyak 1 kali</li>
              <li>Nominal minimum pencairan dana adalah Rp. 16.500.</li>
              <li>
                Sisa nominal dana yang belum dicairkan otomatis diakumulasikan
                untuk bagi hasil selanjutnya.
              </li>
              <li>
                Pencairan dana selain ke rekening BCA. BRI,Mandiri dikenakan
                biaya admin sebesar Rp. 6.500
              </li>
              <li>
                Lama waktu pencairan ke rekening pengguna maksimal 2x24 jam pada
                hari kerja bank.
              </li>
            </ol>
          </div>
