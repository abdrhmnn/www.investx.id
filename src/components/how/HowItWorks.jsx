    ...
    return (
      <div className="how">
        <div className="head">
          ...
          <div className="container jumbo">
            <div className="how-jumbo-content">
              ...
              <div className="desc-jumbo">
                Apakah kamu seorang Investor ataupun pelaku bisnis, siapapun
                bisa dengan mudah menggunakan InvestX
              </div>
            </div>
          </div>
        </div>
        <div className="cara">
          ...
          <p className="desc">
            Ikuti panduan singkat cara investasi dari kami dan dapatkan
            penghasilan rutin dari bagihasil bisnis kamu pilih.
          </p>
        </div>
        <div className="kartu">
              ...
              <div className="karcon">
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <br />
                    <br />
                    Review the company pitch, terms, and decide whether you
              ...
              <div className="karcon">
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <br />
                    <br />
                    Plan to diversify, which means investing smaller amounts
              ...
              <div className="karcon">
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <br />
                    <br />
                    If the startup does well, your investment can bring a
                    return.
                  </li>
                </ul>
              </div>
          ...
          <div className="steps container center">
            <div className="documents row">
              ...
              <div>
                ...
                <p>
                  4. Video perusahaan dalam bentuk link youtube ( Optional )
                </p>
                <p className="text-danger mt-4">
                  * File selain Video di unggah dalam bentuk PNG/ JPEG/ PDF
